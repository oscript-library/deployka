...
* release   - Формирование файла поставки конфигурации
...
## release - Формирование файла поставки конфигурации
Формируется только файл поставки (без файла обновления) в указанный каталог с созданием подкаталога с маской 'гггг-ММ-дд-ЧЧмм'
Пример: F:/Release/ZUP/2021-04-27-1200
### Параметры:
* -db-user        - Пользователь информационной базы
* -db-pwd         - Пароль пользователя информационной базы
* -v8version      - Маска версии платформы 1С
* -uccode         - Код разрешения для запуска ИБ
* -release-folder - Каталог, куда будет формироваться файл поставки
