...
* schedule  - Управление блокировкой регламентных заданий информационной базы
...
* -try - Число попыток обращения по протоколу rac/ras
...
* -dinamic - Динамическое обновление конфигурации
