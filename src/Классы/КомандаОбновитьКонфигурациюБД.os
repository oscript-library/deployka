...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Парсер.ДобавитьПараметрФлагКоманды(ОписаниеКоманды, 
		"-v2",
		"Реструктуризации баз данных 1С v2");
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды) Экспорт
	...
	РеструктуризацияV2 = ПараметрыКоманды["-v2"];
	...
	Попытка
		Если РеструктуризацияV2 Тогда
			Конфигуратор.ОбновитьКонфигурациюБазыДанныхНаСервере(Не ПредупрежденияВозможны, ДинамическоеОбновление,  Конфигуратор.РежимыРеструктуризации().Второй);	
		Иначе 
