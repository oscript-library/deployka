...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды) Экспорт	
    ...
    Попытка
    	Возврат ВыполнитьОбновлениеКонфигурации(СтрокаПодключения, ПутьДистрибутива, Пользователь, Пароль, ТекущийРежим, КлючРазрешения, ИспользуемаяВерсияПлатформы, ИспользуемаяРазрядностьПлатформы);
    Исключение
